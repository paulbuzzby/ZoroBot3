...
main(
    ...
    explore_types=[0],             # Tipo de exploración
...
```
python "array and solve to image.py" --map "maze.map" --sim "./maze_sim" --output "maze_solved.bmp" --floodfill 0 1 2 3 --explore 2 --render sprites --color parts
```
